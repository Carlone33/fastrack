...
return [
    ...
    // No hay configuración de 'assets' en este archivo, por lo que WireUI debería usar los estilos de Vite automáticamente.
    // Si el error persiste, asegúrate de que en tu archivo .env NO tengas la variable WIREUI_ASSETS habilitada.
    // Si existe, comenta o elimina la línea:
    // WIREUI_ASSETS=true
];
