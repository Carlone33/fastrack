                    ...
                    <form wire:submit.prevent="submit" class="mt-5 mr-5 ml-5 mb-5">
                        ...
                        Subir Foto
                            ...
                            @if ($currentStep === 4)
                                ...
                                <x-label>
                                    Juzgado / Circuito Judicial
                                    <input type="text" wire:model="juzgado" class="w-full rounded-lg block mt-2">
                                    @error('juzgado')
                                        <span class="text-red-500 text-xs mt-3 block">{{ $message }}</span>
                                    @enderror
                                </x-label>
                                ...
                                <x-label>
                                    Nº de Oficio
                                    <input type="text" wire:model="numero_oficio"
                                        class="w-full rounded-lg block mt-2">
                                    @error('numero_oficio')
                                        <span class="text-red-500 text-xs mt-3 block">{{ $message }}</span>
                                    @enderror
                                ...
                                <x-label>
                                    Nº de Expediente Tribunal
                                    <input type="text" wire:model="numero_expediente_tribunal"
                                        class="w-full rounded-lg block mt-2">
                                    @error('numero_expediente_tribunal')
                                        <span class="text-red-500 text-xs mt-3 block">{{ $message }}</span>
                                    @enderror
                                </x-label>
                                ...
                                <x-label>
                                    Fecha de Oficio
                                    <input type="date" wire:model="fecha_oficio"
                                        class="w-full rounded-lg block mt-2">
                                    @error('fecha_oficio')
                                        <span class="text-red-500 text-xs mt-3 block">{{ $message }}</span>
                                    @enderror
                                ...
                                <x-label>
                                    Motivo
                                    <input type="text" wire:model="motivo" class="w-full rounded-lg block mt-2">
                                    @error('motivo')
                                        <span class="text-red-500 text-xs mt-3 block">{{ $message }}</span>
                                    @enderror
                                </x-label>
                                ...
                                <div class="space-y-6">
                                    ...
                                    <div x-data="{ previewUrl: null, fileName: null }" class="flex flex-col">
                                        ...
                                        <!-- Input oculto con estilos personalizados -->
                                        <div class="relative">
                                            <input type="file" wire:model="foto_oficio" x-ref="fileInput"
                                                @change="
                                                    fileName = $event.target.files[0]?.name;
                                                    const file = $event.target.files[0];
                                                    if (file && file.type.startsWith('image/')) {
